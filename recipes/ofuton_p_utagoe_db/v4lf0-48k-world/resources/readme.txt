【おふとん P (SimpleEnunu) (NNSVS-WORLD v4) v0.0.1 】
...
1. 単独音歌詞で UST を作成
2. UST を保存
3. 音源に「おふとん P (SimpleEnunu) (NNSVS-WORLD v4) v0.0.1 」を選択
...
- 使用レシピ: NNSVS-WORLD v4 相当 (https://github.com/taroushirani/nnsvs/tree/dev20221106/recipes/ofuton_p_utagoe_db/v4lf0-48k-world)
