【御丹宮くるみ (SimpleEnunu) (NNSVS-WORLD v5+pitch-shift data augmentation+HN-uSFGAN) v0.0.1 】
...
1. 単独音歌詞で UST を作成
2. UST を保存
3. 音源に「御丹宮くるみ (SimpleEnunu) (NNSVS-WORLD v5+pitch-shift data augmentation+HN-uSFGAN) v0.0.1 」を選択
...
- 使用レシピ: NNSVS-WORLD v5 相当 (https://github.com/taroushirani/nnsvs/tree/dev20221106/recipes/oniku_kurumi_utagoe_db/v5-48k-world-psda)
