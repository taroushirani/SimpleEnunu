【夏目悠李 (SimpleEnunu) (NNSVS-WORLD v4) v0.0.1 】
...
1. 単独音歌詞で UST を作成
2. UST を保存
3. 音源に「夏目悠李 (SimpleEnunu) (NNSVS-WORLD v4) v0.0.1 」を選択
...
- 使用レシピ: NNSVS-WORLD v4 相当 (https://github.com/taroushirani/nnsvs/tree/dev20221106/recipes/natsume_singing/v4lf0-48k-world)
